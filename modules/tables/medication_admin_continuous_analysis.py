...
This module provides comprehensive analysis for the medication_admin_continuous table,
including medication group distributions, dose analysis with outlier handling,
and kernel density estimations for multi-unit medications.
"""
...
class MedicationAdminContinuousAnalyzer(BaseTableAnalyzer):
    ...
    - Kernel density estimation for multi-unit medications
    ...
    def get_data_info(self) -> Dict[str, Any]:
        """
        Get medication_admin_continuous data information using DuckDB for efficiency.
    ...
    def generate_medication_summary(self) -> pd.DataFrame:
        """
        Generate a summary dataframe for the medication admin continuous table.
    ...
    def check_data_quality(self) -> Dict[str, Any]:
        """
        Perform data quality checks specific to medication admin continuous.
        ...
        quality_checks['mismatched_category_group'] = {
            ...
            'definition': 'Validates that medications are correctly assigned to their expected medication groups (e.g., norepinephrine should be in vasoactives group). Mismatches may indicate data mapping errors.'
        }
