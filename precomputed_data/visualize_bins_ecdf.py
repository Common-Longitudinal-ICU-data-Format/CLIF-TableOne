#!/usr/bin/env python3
"""
Visualize Precomputed Bins and ECDF

This script creates combined visualizations of bins and ECDF from precomputed data.

Usage:
    # Generate all categories (labs, vitals, respiratory_support)
    python precomputed_data/visualize_bins_ecdf.py

    # Generate single category
    python precomputed_data/visualize_bins_ecdf.py --category sodium --unit "mmol/L" --table labs

    # Generate all labs
    python precomputed_data/visualize_bins_ecdf.py --table labs

    # Generate all vitals
    python precomputed_data/visualize_bins_ecdf.py --table vitals

    # Generate all respiratory support
    python precomputed_data/visualize_bins_ecdf.py --table respiratory_support

Output:
    precomputed_data/plots/{table_type}/{category}_{unit}.html
"""
...
def load_lab_vital_config(config_path: str = 'precomputed_data/configs/lab_vital_config.yaml') -> dict:
...
def discover_files(
    ...
    Args:
        base_dir: Base directory with precomputed data
...
def process_category(
    ...
    unit: Optional[str],
    base_dir: str = 'precomputed_data',
    output_dir: str = 'precomputed_data/plots'
) -> bool:
    """
...
def main():
    parser = argparse.ArgumentParser(
        description='Visualize precomputed bins and ECDF data'
    )
    parser.add_argument(
        '--category',
        type=str,
    ...
    parser.add_argument(
        ...
        help='Base directory with precomputed data'
    )
    parser.add_argument(
        '--output-dir',
        type=str,
        default='precomputed_data/plots',
    ...
    print("\n" + "="*80)
    print("Visualize Precomputed Bins and ECDF")
    print("="*80 + "\n")
