...
def load_outlier_config(config_path: str = 'precomputed_data/configs/outlier_config.yaml') -> Dict[str, Any]:
    """
...
def load_lab_vital_config(config_path: str = 'precomputed_data/configs/lab_vital_config.yaml') -> Dict[str, Any]:
    """
